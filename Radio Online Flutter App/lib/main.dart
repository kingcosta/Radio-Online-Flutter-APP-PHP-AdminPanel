...
import 'package:radio_app/Helper/notificationHandler/awsomeNotification.dart';
import 'package:radio_app/Helper/notificationHandler/notificationService.dart';
    ...
    setState(() {
      if (error == 'true' || (total) == 0) {
        ...
        if ((offset) < total) {
          ...
          updateQueue(choiceIndex: 0, start: false, ind: 0);
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              ListTile(
                  ...
                  onTap: () {
                    LaunchReview.launch(
                      androidAppId: "com.wrteam.radioonline", //your android package name

      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          FutureBuilder(
              ...
              if (snapshot.hasData) {
                return snapshot.data == true
                    ? IconButton(
                        ...
                        onPressed: () async {
                          await db.removeFav(curPlayList![index].id);
                          if (!mounted) {
                            return;
                          }
                          setState(() {});
                    ...
                    : IconButton(
                        ...
                        onPressed: () async {
                          String? id, title, desc, img, url;
                            ...
                            title = curPlayList![index].title;
                            desc = curPlayList![index].description;
                            img = curPlayList![index].image;
                            url = curPlayList![index].radio_url;
            ...
            future: db.getFav(curPlayList![index].id),
          ),
          IconButton(

                    ...
                    children: <Widget>[
                      ...
                      Container(
                          ...
                          child: ListView.builder(
                              ...
                              itemCount: int.parse(projectSnap.data!.length.toString()) > 0 ? int.parse(projectSnap.data!.length.toString()) >= 10 ? 10 : int.parse(projectSnap.data.length.toString()) : 0,
                      ...
                      itemBuilder: (context, i) {
                        return InkWell(
                          ...
                          onTap: () async {
                            ...
                            audios.clear();
                            await updateQueue(choiceIndex: 1,ind: i,start: true);
        ...
        return   assetsAudioPlayer.builderLoopMode(
          ...
          onTap: ()  async {
            ...
            if (index1 < int.parse(curPlayList!.length.toString())) {
              audios.clear();
              updateQueue(choiceIndex: 1,start: true,ind: index1);
